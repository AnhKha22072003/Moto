...
class StoreMotorCycleRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'images' => 'array',
            'images.images.*' => 'image|mimes:jpeg,png,jpg,gif,svg|max:2048',
            'images.*.images' => 'image|mimes:jpeg,png|max:2048|max:70',
        ];
    }
    public function messages()
    {
        return [
            ...
            'images.images.*.image' => 'Ảnh phải là định dạng hình ảnh.',
            'images.images.*.mimes' => 'Ảnh phải có định dạng: jpeg, png, jpg, gif, svg.',
            'images.images.*.max' => 'Ảnh không được vượt quá 2MB.',
            'images.*.images.image' => 'Tập tin phải là hình ảnh.',
            'images.*.images.mimes' => 'Tập tin phải có định dạng jpeg hoặc png.',
            'images.*.images.max' => 'Ảnh không được vượt quá 70KB.',
